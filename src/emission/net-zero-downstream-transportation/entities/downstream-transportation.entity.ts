...
import { DownstreamTransportationEmissionSourceDataMethod } from "../dto/downstream-transportation-dto.dto";

@Entity()
export class DownstreamTransportationActivityData extends EmissionBaseEntity {
    ...
    @Column({
        type: "enum",
        enum: DownstreamTransportationEmissionSourceDataMethod,
        default: null,
        nullable: true
    })
    method: DownstreamTransportationEmissionSourceDataMethod;
